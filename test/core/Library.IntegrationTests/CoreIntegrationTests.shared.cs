...
namespace LIBRARY.IntegrationTests
{
    ...
    public class CoreIntegrationTests : CoreTestBase<CoreIntegrationTests, CoreTestFixture<CoreIntegrationTests>>
    {
        ...
        public CoreIntegrationTests(ITestOutputHelper testOutputHelper,
            CoreTestFixture<CoreIntegrationTests> testFixture)
        ...
        [Fact]
        public void CoreIntegration_HasPlatformTraitAttribute()
        {
            this.TestClassType.HasPlatformTraitAttribute().Should().BeTrue();
        }

        [Fact]
        public void CoreIntegration_GetTraitOperatingSystem()
        {
        ...
        [Fact]
        public void CoreIntegration_GetTraitTestType()
        {
            this.TestClassType.GetTraitTestType().Should().Be(TraitTestType.Integration);
        }

        [Fact]
        public void CoreIntegration_OutputTraits()
        {
